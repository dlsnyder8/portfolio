  ...
  schools: [
    {
      ...
      logo: require("./assets/images/PrincetonLogo.png"),
      subHeader: "Bachelors of Arts in Computer Science",
      duration: "July 2018 - June 2022",
      desc: "",
      descBullets: [
        "Co-Founder/Treasurer/Technology Chair for the Princeton Coffee Club",
        "Outdoor Action Leader"
      ]
    }
  ]
};
  ...
  experience: [
    {
      ...
      url: "https://apexleaders.com",
      company: "Apex Leaders",
      companylogo: require("./assets/images/apexleaders.png"),
      date: "Sept 2022 – Present",
      desc: "Jack of all Trades",
      descBullets: [
        "Developed internal tools to automate processes and increase efficiency",
        "Vendor Liason",
    ...
    {
      role: "Treasurer/Technology Chair",
